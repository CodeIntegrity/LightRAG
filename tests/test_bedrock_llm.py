...
def _make_args(tmp_path) -> SimpleNamespace:
    return SimpleNamespace(
        ...
        workspace="",
        workspace_registry_path=str(tmp_path / "workspaces" / "registry.sqlite3"),
        workspace_registry_busy_timeout_ms=5000,
        max_cached_workspaces=8,
        workspace_runtime_idle_ttl=300,
        workspace_drain_timeout=5,
